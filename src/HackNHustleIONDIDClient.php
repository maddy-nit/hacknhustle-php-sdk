...
use HackNHustleIONDIDLib\Utils\CompatibilityConverter;
use Unirest\Configuration;
use Unirest\HttpClient;

class HackNHustleIONDIDClient implements ConfigurationInterface
{
    private $misc;
    ...
    /**
     * @see HackNHustleIONDIDClientBuilder::init()
     * @see HackNHustleIONDIDClientBuilder::build()
     *
     * @param array $config
     */
     ...
     *
     * @return HackNHustleIONDIDClientBuilder HackNHustleIONDIDClientBuilder instance
     */
    public function toBuilder(): HackNHustleIONDIDClientBuilder
    {
        return HackNHustleIONDIDClientBuilder::init()
     ...
     *
     * @see HackNHustleIONDIDClientBuilder::getConfiguration()
     */
     ...
     * @var array
     */
    private const ENVIRONMENT_MAP = [Environment::PRODUCTION => [Server::SERVER_1 => 'http://example.com']];
}
