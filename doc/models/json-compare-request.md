...
|  --- | --- | --- | --- | --- | --- |
| `jsonFirst` | [`JsonFirst`](../../doc/models/json-first.md) | Required | - | getJsonFirst(): JsonFirst | setJsonFirst(JsonFirst jsonFirst): void |
| `jsonSecond` | [`JsonSecond`](../../doc/models/json-second.md) | Required | - | getJsonSecond(): JsonSecond | setJsonSecond(JsonSecond jsonSecond): void |
